...
import edu.softech.shoesShop.repository.OrderDetailRepository;
...
public class OrderDetailServiceImpl implements OrderDetailService {
	...
	@Override
	public List<OrderDetail> findByShoes(Shoes shoes) {
		return orderDetailRepository.findByShoes(shoes);
	}
